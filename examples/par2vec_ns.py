...
# Following models learn by negative sampling as opposed to
# hierarchical softmax
simple_models = [
    # PV-DM w/concatenation - window=5 (both sides) approximates
    #     paper's 10-word total window size
    Doc2Vec( dm=1, dm_concat=1, size=100, window=10, negative=5,
             hs=0, min_count=2, workers=cores ),
    # PV-DBOW
    Doc2Vec(dm=0, size=100, negative=5, hs=0, min_count=2, workers=cores),
    # PV-DM w/average
    Doc2Vec( dm=1, dm_mean=1, size=100, window=10, negative=5, hs=0,
